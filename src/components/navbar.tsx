  ...
  return (
    <div className="relative">
      <div className="bg-white flex items-center justify-center">
        <header className="md:px-3 px-7 md:-translate-x-0 py-3 md:py-7 fixed md:top-1/2 top-4 md:left-4 md:-translate-y-20 z-30 border border-zinc-700 border-opacity-30 bg-zinc-900 md:w-fit rounded-3xl">
