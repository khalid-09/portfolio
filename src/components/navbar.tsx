...
const Navbar = () => {
  ...
  return (
    <header className="md:px-3 px-7  left-1/2 -translate-x-24 md:-translate-x-0 py-3 md:py-7 fixed md:top-1/2 top-4   md:left-4 md:-translate-y-20 z-10  border border-zinc-400 border-opacity-30 bg-zinc-900 md:w-fit rounded-3xl">
